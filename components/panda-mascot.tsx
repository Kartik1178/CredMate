...
export function PandaMascot({
  ...
  const getDefaultMessage = () => {
    if (language === "es") {
      return "¡Hola! Soy Bankmonger, tu asistente financiero virtual. ¿En qué puedo ayudarte hoy?"
    }
    return "Hi there! I'm Bank manager, your virtual financial assistant. How can I help you today?"
  }
